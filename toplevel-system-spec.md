...
3. **Organization**: CLI2 presents these values in structured, navigable interfaces
4. **Access**: Users can browse, search, and interact with toplevels through the CLI

## CLI2 Integration

The CLI2 navigation system integrates seamlessly with toplevels:
...
- ✅ Define basic toplevel types
- ✅ Create CLI2 integration points
- 🚧 Implement mock data scanning

### Phase 2: Real Package Scanning
- Scan package system for toplevel values
- Implement dynamic discovery
- Cache toplevel metadata for performance

### Phase 3: Advanced Features
- Cross-toplevel references and relationships
- Search and filtering capabilities
- Real-time updates as packages change

### Phase 4: Tooling Integration
- IDE support for toplevel navigation
- Visual toplevel browsers
- Export/import toplevel definitions

## Usage Examples

### Creating an HttpHandler
```darklang
let myApi = Darklang.Cli2.Toplevels.HttpHandler
  { path = "/api/users"
    method = "GET"
...
### Creating a Script
```darklang
let deployScript = Darklang.Cli2.Toplevels.Script
  { name = "deploy"
...
```darklang
let apiDocs = Darklang.Cli2.Toplevels.Markdown
...
The toplevel system enables a shift from file-based to content-based organization. Instead of thinking "where did I put that file?", developers think "what type of thing am I looking for?" The system becomes a semantic layer over the codebase, making it easier to understand, navigate, and maintain large projects.
