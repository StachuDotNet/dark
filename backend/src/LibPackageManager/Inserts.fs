...
let insertAndApplyOps (commitId : Option<System.Guid>) (ops : List<PT.PackageOp>) : Task<int64> =
  task {
...
let insertAndApplyOpsWithCommit (message : string) (ops : List<PT.PackageOp>) : Task<System.Guid> =
  task {
