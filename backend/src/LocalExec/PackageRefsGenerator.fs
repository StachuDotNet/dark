/// After reload-packages, writes `package-ref-hashes.txt` with current hashes
/// from the DB. PackageRefs.fs reads this file (as an embedded resource) at startup.
module LocalExec.PackageRefsGenerator
