...
/// stamped NEWER. When cross-instance sync is (re)introduced, its wire-format version IS this same integer
/// — one coordinate gates both the local store upgrade and cross-instance compatibility.
