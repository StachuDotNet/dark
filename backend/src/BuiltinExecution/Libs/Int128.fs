...
let fns : List<BuiltInFn> =
  [ { name = fn "int128Mod" 0
      ...
      fn =
        ...
        | _, vm, _, [ DInt128 v; DInt128 m ] ->
          if m = System.Int128.Zero then
            ...
            Task.FromResult(DInt128(result))
        | _ -> incorrectArgs ())
    ...
    { name = fn "int128Remainder" 0
      ...
      fn =
        let resultOk r = Dval.resultOk KTInt128 KTString r |> Task.FromResult
        (function
    ...
    { name = fn "int128GreaterThan" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt128 a; DInt128 b ] -> Task.FromResult(DBool(a > b))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128ToString" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt128 a ] -> Task.FromResult(DString(string a))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128ToFloat" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt128 a ] -> Task.FromResult(DFloat(float a))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128Sqrt" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt128 a ] -> Task.FromResult(DFloat(sqrt (float a)))
        | _ -> incorrectArgs ())
    ...
    { name = fn "int128Parse" 0
      ...
      fn =
        ...
        | _, _, _, [ DString s ] ->
          try
            s |> System.Int128.Parse |> DInt128 |> resultOk |> Task.FromResult
          with
          | :? System.FormatException ->
            ParseError.BadFormat |> ParseError.toDT |> resultError |> Task.FromResult
          | :? System.OverflowException ->
            ParseError.OutOfRange |> ParseError.toDT |> resultError |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128FromInt8" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt8 a ] -> DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128FromUInt8" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt8 a ] -> DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128FromInt16" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt16 a ] -> DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128FromUInt16" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt16 a ] -> DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128FromInt32" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt32 a ] -> DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128FromUInt32" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt32 a ] -> DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128FromInt64" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt64 a ] -> DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128FromUInt64" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt64 a ] -> DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated } ]
