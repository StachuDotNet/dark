...
module ParseError =
  ...
  let toDT (e : ParseError) : Dval =
    ...
    let typeName = FQTypeName.fqPackage (PackageRefs.Type.Stdlib.int128ParseError ())
  ...
  [ { name = fn "int128Mod" 0
    ...
    { name = fn "int128FromInt8" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt8 a ] ->
          DInt128(System.Int128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128BitwiseAnd" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt128 a; DInt128 b ] -> Task.FromResult(DInt128(a &&& b))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128BitwiseNot" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt128 a ] ->
          Task.FromResult(DInt128(System.Int128.op_OnesComplement (a)))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "int128ShiftLeft" 0
      ...
      fn =
        (function
        | _, _, _, [ DInt128 a; DInt128 b ] -> Task.FromResult(DInt128(a <<< int b))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
