...
let fns () : List<BuiltInFn> =
  [ { name = fn "uint32Mod" 0
    ...
    { name = fn "uint32Power" 0
      ...
      fn =
        ...
        | _, vm, _, [ DUInt32 number; DUInt32 exp ] ->
          (try
            (bigint number) ** (int exp) |> uint32 |> DUInt32 |> Task.FromResult
           with :? System.OverflowException ->
             RTE.Ints.OutOfRange |> RTE.Int |> raiseRTE vm.threadID)
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
        ...
        | _, vm, _, [ DUInt32 a; DUInt32 b ] ->
          if b = 0ul then
            ...
            then
              ...
              Task.FromResult(DUInt32(uint32 result))
    ...
    { name = fn "uint32GreaterThan" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt32 a; DUInt32 b ] -> Task.FromResult(DBool(a > b))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint32ToString" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt32 a ] -> Task.FromResult(DString(string a))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint32ToFloat" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt32 a ] -> Task.FromResult(DFloat(float a))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint32Random" 0
      ...
      fn =
        ...
        | _, _, _, [ DUInt32 a; DUInt32 b ] ->
          ...
          Task.FromResult(DUInt32(uint32Result))
    ...
    { name = fn "uint32Sqrt" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt32 a ] -> Task.FromResult(DFloat(sqrt (float a)))
        | _ -> incorrectArgs ())
    ...
    { name = fn "uint32Parse" 0
      ...
      fn =
        ...
        | _, _, _, [ DString s ] ->
          try
            s |> System.Convert.ToUInt32 |> DUInt32 |> resultOk |> Task.FromResult
          with
    ...
    { name = fn "uint32FromInt8" 0
      ...
      fn =
        ...
        | _, _, _, [ DInt8 a ] ->
          if (a < 0y) then
            Dval.optionNone KTUInt32 |> Task.FromResult
          else
            Dval.optionSome KTUInt32 (DUInt32(uint32 a)) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint32FromUInt8" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt8 a ] -> DUInt32(uint32 a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint32FromUInt16" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt16 a ] -> DUInt32(uint32 a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint32BitwiseAnd" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt32 a; DUInt32 b ] -> Task.FromResult(DUInt32(a &&& b))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint32BitwiseNot" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt32 a ] -> Task.FromResult(DUInt32(~~~a))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint32ShiftLeft" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt32 a; DUInt32 b ] -> Task.FromResult(DUInt32(a <<< int b))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
