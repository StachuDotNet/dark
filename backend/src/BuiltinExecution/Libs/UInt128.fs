...
let fns () : List<BuiltInFn> =
  [ { name = fn "uint128Mod" 0
      ...
      fn =
        ...
        | _, vm, _, [ DUInt128 v; DUInt128 m ] ->
          if m = System.UInt128.Zero then
            ...
            Task.FromResult(DUInt128(result))
        | _ -> incorrectArgs ())
    ...
    { name = fn "uint128GreaterThan" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt128 a; DUInt128 b ] -> Task.FromResult(DBool(a > b))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint128ToString" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt128 a ] -> Task.FromResult(DString(string a))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint128ToFloat" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt128 a ] -> Task.FromResult(DFloat(float a))
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint128Sqrt" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt128 a ] -> Task.FromResult(DFloat(sqrt (float a)))
        | _ -> incorrectArgs ())
    ...
    { name = fn "uint128Parse" 0
      ...
      fn =
        ...
        | _, _, _, [ DString s ] ->
          try
            s |> System.UInt128.Parse |> DUInt128 |> resultOk |> Task.FromResult
          with
    ...
    { name = fn "uint128FromUInt8" 0
      ...
      fn =
        (function
        | _, _, _, [ DUInt8 a ] ->
          DUInt128(System.UInt128.op_Implicit a) |> Task.FromResult
        | _ -> incorrectArgs ())
      sqlSpec = NotYetImplemented
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint128BitwiseAnd" 0
      typeParams = []
      parameters = [ Param.make "a" TUInt128 ""; Param.make "b" TUInt128 "" ]
      returnType = TUInt128
      description = "Bitwise AND on two <type UInt128> values"
      fn =
        (function
        | _, _, _, [ DUInt128 a; DUInt128 b ] -> Task.FromResult(DUInt128(a &&& b))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint128BitwiseOr" 0
      typeParams = []
      parameters = [ Param.make "a" TUInt128 ""; Param.make "b" TUInt128 "" ]
      returnType = TUInt128
      description = "Bitwise OR on two <type UInt128> values"
      fn =
        (function
        | _, _, _, [ DUInt128 a; DUInt128 b ] -> Task.FromResult(DUInt128(a ||| b))
        | _ -> incorrectArgs ())
    ...
    { name = fn "uint128BitwiseXor" 0
      typeParams = []
      parameters = [ Param.make "a" TUInt128 ""; Param.make "b" TUInt128 "" ]
      returnType = TUInt128
      description = "Bitwise XOR on two <type UInt128> values"
      fn =
        (function
        | _, _, _, [ DUInt128 a; DUInt128 b ] -> Task.FromResult(DUInt128(a ^^^ b))
        | _ -> incorrectArgs ())
    ...
    { name = fn "uint128BitwiseNot" 0
      typeParams = []
      parameters = [ Param.make "a" TUInt128 "" ]
      returnType = TUInt128
      description = "Bitwise NOT on a <type UInt128> value"
      fn =
        (function
        | _, _, _, [ DUInt128 a ] ->
          Task.FromResult(DUInt128(System.UInt128.op_OnesComplement (a)))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint128ShiftLeft" 0
      typeParams = []
      parameters = [ Param.make "a" TUInt128 ""; Param.make "b" TUInt128 "" ]
      returnType = TUInt128
      description = "Bitwise left shift of a <type UInt128> value"
      fn =
        (function
        | _, _, _, [ DUInt128 a; DUInt128 b ] ->
          Task.FromResult(DUInt128(a <<< int b))
        | _ -> incorrectArgs ())
      sqlSpec = NotQueryable
      previewable = Pure
      deprecated = NotDeprecated }
    ...
    { name = fn "uint128ShiftRight" 0
      typeParams = []
      parameters = [ Param.make "a" TUInt128 ""; Param.make "b" TUInt128 "" ]
      returnType = TUInt128
      description = "Bitwise right shift of a <type UInt128> value"
      fn =
        (function
        | _, _, _, [ DUInt128 a; DUInt128 b ] ->
          Task.FromResult(DUInt128(a >>> int b))
