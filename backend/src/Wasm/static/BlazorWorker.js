...
function toLogicalRootCommentElement(start, end) {
    ...
    const parentLogicalElement = LogicalElements_toLogicalElement(parent, /* allow existing contents */ true);
...
function JSRootComponents_getAndRemovePendingRootComponentContainer(containerIdentifier) {
...
const currentBrowserIsChromeOrEdge = brands
    ...
    : window.chrome;
const MonoDebugger_platform = (_b = (_a = navigatorUA.userAgentData) === null || _a === void 0 ? void 0 : _a.platform) !== null && _b !== void 0 ? _b : navigator.platform;
...
async function compileWasmModule(wasmResource, imports) {
    ...
    const hasWasmContentType = ((_a = wasmResourceResponse.headers) === null || _a === void 0 ? void 0 : _a.get('content-type')) === 'application/wasm';
...
async function boot(options) {
  console.log('booting', options)
    ...
    Blazor._internal.navigationManager.listenForNavigationEvents(async (uri, state, intercepted) => {
        await DotNet.invokeMethodAsync('Microsoft.AspNetCore.Components.WebAssembly', 'NotifyLocationChanged', uri, state, intercepted);
    }, async (callId, uri, state, intercepted) => {
        const shouldContinueNavigation = await DotNet.invokeMethodAsync('Microsoft.AspNetCore.Components.WebAssembly', 'NotifyLocationChangingAsync', uri, state, intercepted);
