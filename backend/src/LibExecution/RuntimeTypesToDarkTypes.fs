...
module FQTypeName =
  ...
  module Package =
    ...
    let toDT (hash : FQTypeName.Package) : Dval = DString(Hash.toString hash)
...
module FQValueName =
  ...
  module Package =
    let toDT (hash : FQValueName.Package) : Dval = DString(Hash.toString hash)
...
module FQFnName =
  ...
  module Package =
    let toDT (hash : FQFnName.Package) : Dval = DString(Hash.toString hash)
