...
type TerminalElement = string // TODO this shoul

// We need to expose (just) this Program type in Dark,
// and respect it in the CLI runtime.
...
module Program =
  ...
  let withSubscription
    ...
    =
    let sub model = Cmd.batch [ program.subscribe model; subscribe model ]
  ...
  let withConsoleTrace (program : Program<'arg, 'model, 'msg, 'view>) =
    ...
    { program with init = traceInit; update = traceUpdate }
