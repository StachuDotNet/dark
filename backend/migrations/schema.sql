...
-- content-addressed op can be pushed by several identities. FAKE AUTH -- `owner` is an unsigned
-- identity string, trusted by convention. Only a relay populates this; an instance ignores it.
