/// THIS IS ALL EXPERIMENTAL - see README.md
module BwdDangerServer.Server
...
let configureServices (services : IServiceCollection) : unit =
  ...
  |> Telemetry.AspNet.addTelemetryToServices
    "BwdDangerServer"
    Telemetry.TraceDBQueries
...
let main _ =
  try
    ...
    LibRealExecution.RealExecution.additionalStdlib <- StdLib.contents
    ...
    0
  with e ->
    Rollbar.lastDitchBlockAndPage "error starting bwddangerserver" e
