...
[distributed-event-sourcing.md](distributed-event-sourcing.md) (the substrate
...
- **Renames, moves, wraps are ops, not regex.** "Wrap this expression in a
  ...
  conflicts cleanly with concurrent edits ([conflicts](conflicts.md)) and
...
[distributed-event-sourcing.md](distributed-event-sourcing.md)). Sketch:
...
delegated LLM call, per [distributed-event-sourcing.md](distributed-event-sourcing.md)
