...
> **Note (post-restructure):** the file paths below predate the theme-based reorg. The print already ran once; for current paths use the reading order in the top-level `README.md`. Kept for the curation rationale (which files, and why the 125 specs are excluded).
...
6. `distributed-event-sourcing.md` — **keystone**
7. `apps-surface.md` — `dark apps` (north-star surface)
8. `event-bus.md`
9. `conflicts.md`
10. `sync.md`
11. `async.md`
...
14. `cohabitation.md`
15. `remote-access.md`
16. `package-system-layers.md`
17. `bootstrap.md` — removing `.dark` files (punted)
18. `pdd.md`
19. `algorithm.md`
20. `claims.md`
21. `pdd-elevator-pitches.md`
22. `capabilities.md`
23. `identity.md`
24. `composable-mvu.md`
25. `view-sketches.md`
26. `structural-editor.md`
27. `dark-virtual-files.md`
