...
|---|---|
| [event-bus.md](event-bus.md) | **[vision]** the *live/push* substrate — push sync, await, hot-reload. The floor folds ops by **poll**, not the bus; punted off the critical path. |
| [async.md](async.md) | **[vision]** how a frame waits on a not-yet-resolved op |
